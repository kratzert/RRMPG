...
from .cemaneigegr4j_model import run_cemaneigegr4j
...
class CemaneigeGR4J(BaseModel):
    ...
    Cemaneige snow routine [1] and the GR4J model [2]. This model should only 
    ...
    _param_list = ['CTG', 'Kf', 'x1', 'x2', 'x3', 'x4']
    ...
    def __init__(self, params=None):
        """Initialize a Cemaneige + GR4J coupled hydrological model object.
    ...
    def simulate(self, prec, mean_temp, min_temp, max_temp, etp, 
        ...
        for i in range(params.size):    
            if return_storages:
                ...
                qsim[:, i], _, _, _, _ = run_cemaneigegr4j(prec, mean_temp, etp,
                                                           frac_solid_prec, 
                                                           snow_pack_init, 
                                                           thermal_state_init,
                                                           s_init, r_init,
    ...
    def fit(self, obs, prec, mean_temp, min_temp, max_temp, etp, 
        ...
        args = (obs, prec, mean_temp, frac_solid_prec, etp, snow_pack_init, 
                thermal_state_init, s_init, r_init, self._dtype)
...
def _loss(X, *args):
    ...
    outflow, _, _, _, _ = run_cemaneigegr4j(prec, mean_temp, etp, 
